...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard",style={'color':'#503D36','textAlign':'center','font-size':24}),#Include style for title
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec,values=exp_rec.values,names=exp_rec.index,title="Total Expenditure Share by Vehicle Type During Recessions"))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas,x='Year',y='Automobile_Sales',title='Yearly Automobile Sales Statistics'))
